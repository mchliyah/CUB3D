...
/*   Updated: 2022/12/28 01:07:10 by mchliyah         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool	init_player(t_cub *cub)
{
	...
	cub->player.speed_mov = 0.2;
	cub->player.speed_rot = 0.2 * (M_PI / 180);
	cub->player.rot_angle = M_PI_2; // to check if it's correct
	return (true);
}
